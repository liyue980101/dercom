    ...
    public static function make_post_form($title, array $field, $url ,$jscallback = 2)
    {
        ...
        switch ($jscallback) {
            case 1:
                ...
                break;
            case 2:
                $js ="setTimeout(function(){parent.layer.close(parent.layer.getFrameIndex(window.name));},2000);";
               // $js = 'setTimeout(function(){parent.layer.close(parent.layer.getFrameIndex(window.name));},2000);';//提交成功父级页面刷新并关闭当前页面
                break;
            case 3:
            ...
            case 4:
                ...
                break;
            case 5:
                $js = 'console.log($r.btn);$r.btn.disabled(false);$r.btn.loading(false);setTimeout(function(){parent.layer.close(parent.layer.getFrameIndex(window.name));},2000);';//父级不刷新 不能再提交 关闭弹窗
                break;
            case 6:
